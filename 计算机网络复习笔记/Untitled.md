...
C: 源地址可以是单播、多播或广播地址
D: MAC地址长度为48bit
答案: 【 源地址可以是单播、多播或广播地址】源地址不能是广播地址
...
答案: 【 每次加入或更新转发表时，加入或更改的表项被赋予一个IP地址】  mac地址
...
选项：
A: 前缀长度是 18 ，剩余的 14 位可以表示 个此前缀的 IP 地址。
B: 此前缀的IP 地址共享低 14 位。
C:前缀长度是 14，剩余的 14 位可以表示214个此前缀的的 IP 地址。
D:前缀长度是 14，剩余的 18 位可以表示218个此前缀的 IP 地址。】
...
<img src="./assets/image-20230626112740474.png" alt="image-20230626112740474" style="zoom:67%;" />
